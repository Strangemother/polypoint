"""
Django settings for primary project.
...
POLYPOINT_SRC_DIR = SITE_DIR / 'point_src'
POLYPOINT_DEMO_DIR = SITE_DIR / 'demos'
POLYPOINT_SITE_DEMO_DIR = SITE_DIR / 'site_demos'
