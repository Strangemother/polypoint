...
window.addEventListener('mousedown', canvas.onmousedown);
window.addEventListener('mouseup', canvas.onmouseup);
window.addEventListener('mousemove', canvas.onmousemove);
