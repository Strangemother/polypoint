    ...
    run(world) {
        ...
        for (var i = 0; i < len; i++) {
            ...
            if(el.x < 0
                ...
                || el.x > 2000
                || el.y > 2000) {
                el.x = 200 // + Math.random() * 800
                el.y = 200 // + Math.random() * 800
                continue
            }
        ...
        for (var i = 0; i < len; i++) {
            ...
            _this.vx = clamp(_this.vx + cos * trailSpeed * force_grav, clampMin, clampMax);
            _this.vy = clamp(_this.vy + sin * trailSpeed * force_grav, clampMin, clampMax);
