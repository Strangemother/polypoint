...
const creatureTick = function() {
    ...
    creature.rotation += (relRotation -.5 ) * 2 + ((random.float() - .49) * 8)
...
const getBrainResult = function() {
    ...
    stage.label.text = getRotationCorrection(p, t).toFixed(3)
...
const buildBrain = function(){
    ...
    if(window.NEURONS && (loadNeurons == true)) {
