...
var fractal = document.getElementById( 'fractal' )
  ...
  ,   width = 200 // circles.width
  ,  height = 200 // circles.height
...
circles.width = fractal.width = 800
circles.height = fractal.height = 600
...
function render(){
  ...
  if( !( ++rCount % 20 ) ){
    fCtx.fillRect( 0, 0, width + 100, height + 100 );
  }

  // clear the circles
  cCtx.clearRect( 0, 0, width + 100, height + 100 );
