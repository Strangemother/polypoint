...
(function(w) {
    ...
    */
    var canvas_width = 600; //Needs to be a multiple of the resolution value below.
    ...
    function update_particle() {
        ...
        for (i = 0; i < particles.length; i++) {
            ...
            if (p.x >= 0 && p.x < canvas_width && p.y >= 0 && p.y < canvas_height) {
                ...
                */
                p.xv += (1 - ax) * cell_data.xv * mul;
                p.yv += (1 - ay) * cell_data.yv * mul;
                ...
                */
                p.xv += ax * cell_data.right.xv * mul;
                p.yv += ax * cell_data.right.yv * mul;

                p.xv += ay * cell_data.down.xv * mul;
                p.yv += ay * cell_data.down.yv * mul;
            ...
            //These lines divide the particle's velocity in half everytime it loops,
            // slowing them over time.
            p.xv *= 0.5;
            p.yv *= 0.5;
        }
    }
