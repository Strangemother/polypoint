...
class MainStage extends Stage {
    ...
    createPoints(width=200,  pj=this.projectionLength) {
        ...
        this.controlPointsDistances = [
            this.controlPoints[0].distance2D(this.eggPoints[0])
            , this.controlPoints[1].distance2D(this.eggPoints[1])
    ...
    updatePointsToControl(){
        ...
        */
        this.controlPoints.forEach((p,i)=>{
            ...
            p.xy = this.eggPoints[i].add(currentDistance).xy
        })
